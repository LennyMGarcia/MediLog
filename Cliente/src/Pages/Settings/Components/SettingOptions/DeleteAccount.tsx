  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography variant="h6" sx={{  padding: isMediumScreen ? "2rem 0 0.5rem 6rem" : "2rem 0 0 2rem" }}>Eliminar cuenta</Typography>
        <Box sx={{ padding: isMediumScreen ? "0 10rem 1rem 6rem" : "0 2rem 1rem 2rem", color: "gray" }}>
        ...
        <Button variant="contained" sx={{ backgroundColor: "red", marginLeft: isMediumScreen ?  "7rem" : "2rem", "&:hover": { backgroundColor: "#8b0000" } }} onClick={handleModalOpen}>Eliminar cuenta</Button>
