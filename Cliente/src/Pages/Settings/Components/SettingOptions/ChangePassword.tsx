...
import usePasswordStore, {
  getAllPasswordData,
} from "../../stateManagement/passwordStateManagement";
...
const getPasswordSchema = (contrasenaFromDatabase: string) => {
  return Yup.object({
    ...
    confirmarNuevaContrasena: Yup.string()
      .oneOf(
        [Yup.ref("contrasenaNueva"), undefined],
            ...
            {({ handleSubmit, isValid, dirty }) => (
              <Form onSubmit={handleSubmit}>
                <Typography
                  variant="h6"
                  sx={{
                    padding: isMediumScreen ? "3rem 0 0 5rem" : "3rem 0 0 2rem",
                  }}
                >
                  Cambiar contraseña
                </Typography>
                <Typography
                  ...
                  sx={{
                    color: "gray",
                    margin: isMediumScreen ? "1px 0 0 5rem" : "0 3rem 0 3rem",
                  }}
                >
                  Su nueva contraseña debe ser diferente a la contraseña actual
                </Typography>
                <Grid container>
                  <Grid item md={6} xs={12}>
                    <Box sx={{ marginLeft: isMediumScreen ? "5rem" : "2rem" }}>
                      <SettingsInput
                        ...
                        placeHolder="Escriba su contrasena actual"
                      />
                      {/*Ojo con este, aqui hay un zustandCallback, si quieres cambiar algo 
                                            en el state management siempre sera correcto por la tipificacion*/}
                      <SettingsInput
                        zustandCallback={setPasswordData}
                        label="Nueva contrasena"
                        name="contrasenaNueva"
                        placeHolder="Escriba su nueva contrasena"
                      />
                      <SettingsInput
                        label="Confirmar nueva contraseña"
                        name="confirmarNuevaContrasena"
                        placeHolder="coonfirme su nueva contrasena"
                      />
                    </Box>
                  </Grid>
                  <Grid item md={6} xs={12}>
                    <Box
                      sx={{
                        margin: isMediumScreen ? " 0 6rem 0 0" : " 1rem 2rem",
                        color: "gray",
                      }}
                    >
                      <Typography variant="subtitle1">
                        La nueva contraseña debe seguir los siguientes
                        parametros de nuestra politica de contrasena
                      </Typography>
                      <ul>
                        <li>
                          <Typography variant="subtitle1">
                        ...
                        <li>
                          <Typography variant="subtitle1">
                            La contraseña debe tener maximo 24 caracteres
                          </Typography>
                        </li>
                        <li>
                          <Typography variant="subtitle1">
                            Se prefiera que no se utilice una cuenta del 1 hasta
                            el 9 y que se eviten claves como fecha de nacimiento
                            sin anadir algo para que la contraseña sea mas
                            segura
                          </Typography>
                        </li>
                      </ul>
